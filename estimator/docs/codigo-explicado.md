...
[`session-06-ingesta.md`](session-06-datadrivenai-analisis-normalizacion/session-06-ingesta.md); aquí el mapa rápido:
...
[`session-08-datadrivenai-bbdd-vectoriales/session-08.md`](session-08-datadrivenai-bbdd-vectoriales/session-08.md); aquí va el mapa pieza a pieza.
