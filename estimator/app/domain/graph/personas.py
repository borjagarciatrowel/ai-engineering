...
would carry the matching visual identity (name/avatar/tagline) in an Angular
equivalent if/when the wizard grows a graph-driven UI — see the exercise doc for the
Angular-vs-Rails divergence note.
