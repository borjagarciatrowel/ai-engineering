...
The business backend drives the human part: it renders each ``pending_gate`` in the
platform UI and calls ``resume`` when the person approves. The service IA only
...
# comparison path keep working); a graph-driven wizard would drive this trio.   #
# --------------------------------------------------------------------------- #
