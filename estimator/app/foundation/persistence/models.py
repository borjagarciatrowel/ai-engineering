...
class Base(DeclarativeBase):
    ...
    Distinct from ``app.foundation.persistence.db.Base`` on purpose: Alembic's autogenerate targets
    only this metadata (the two Session-6 tables), leaving the Session-5 tables
    to ``app.foundation.persistence.db.create_all``.
    """
