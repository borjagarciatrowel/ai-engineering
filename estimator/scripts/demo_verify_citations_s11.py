...
def _retrieved() -> list[RetrievedChunk]:
    ...
    return [
        RetrievedChunk(
            id=101,
            content="BUD-2024-014 :: AUTH-001 OAuth 2.0 authentication backend — 120 h",
            sector="fintech",
            project_year=2024,
            chunk_type="budget_component",
            distance=0.21,
            source_id="BUD-2024-014",
            budget_id="BUD-2024-014",
        ),
        RetrievedChunk(
            id=102,
            content="BUD-2024-014 :: PAY-002 Instant payments gateway integration — 200 h",
            sector="fintech",
            project_year=2024,
            chunk_type="budget_component",
            distance=0.27,
        ...
        RetrievedChunk(
            id=103,
            content="BUD-2024-040 :: LEDGER-001 Double-entry ledger — 200 h",
            sector="fintech",
            project_year=2024,
            chunk_type="budget_component",
            distance=0.31,
            source_id="BUD-2024-040",
            budget_id="BUD-2024-040",
        ),
    ]
...
def _estimate() -> Estimate:
    ...
    return Estimate(
                    ...
                    TaskItem(
                        ...
                        sources=[
                            SourceReference(
                                chunk_id="102",
                                document_id="BUD-2024-014",
                                evidence="PAY-002 Instant payments gateway integration — 200 h",
                            )
                        ],
                    ),
                ],
                ...
                tasks=[
                    ...
                    TaskItem(
                        ...
                        sources=[
                            SourceReference(
                                chunk_id="999",
                                document_id="BUD-2024-040",
                                evidence="LEDGER-001 Double-entry ledger — 200 h",
                            )
                        ],
                    ),
                ],
        ...
        confidence="high",
        reasoning="Derived from the retrieved BUD-2024-014 and BUD-2024-040 components.",
    )
...
def _print_report(report: CitationReport) -> None:
    ...
    print()
    print(f"{'module':<16} {'line':<26} {'status':<13} cited -> dangling")
    print("-" * 88)
    for line in report.lines:
        print(
            f"{line.module:<16} {line.component:<26} {line.status:<13} "
